      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(380px,1fr))] gap-8">
          ...
          <div className="bg-[var(--cream)] p-12 rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
            <div className="w-12 h-12 bg-[var(--cyan)] rounded-xl flex items-center justify-center mb-6">
          ...
          <div className="bg-[var(--navy)] text-white p-12 rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)] border-2 border-[var(--cyan)]">
